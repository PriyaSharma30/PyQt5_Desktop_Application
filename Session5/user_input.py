...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.run_pushButton = QtWidgets.QPushButton(self.centralwidget,clicked=lambda:self.start_process())
    ...
    def start_process(self):
        ...
        if self.p is None:
            ...
            self.p.start("python",['/home/sharma_priya/Documents/Desktopapp/Session5/ping.py'])    
