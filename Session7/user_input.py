...
class Ui_MainWindow(object):
    ...
    def start_process(self):
        ...
        if self.p is None:
            ...
            self.p.start("python",['/home/sharma_priya/Documents/Desktopapp/Session7/ping.py'])    

    def Loading(self):
        self.main_win=QWidget()
        self.verticalLayout=QtWidgets.QVBoxLayout(self.main_win)
        self.label_ani=QLabel(self.main_win)
        self.movie=QMovie("{}/loading.gif".format(directory_path))
    ...
    def openSaveDialog(self):
        ...
        file_path='{}/save.txt'.format(directory_path)
